...
bg_image = Image.open("C:/Users/Prasad/internship-project/Stenography/Stenography/pic1.jpg")  
...
header = tk.Label(root, text="Secure Hiding Information in Images Using Steganography",
                  font=("Arial", 16, "bold"), fg="black", bg="orange")
header.pack(pady=10, fill="x")

top_fields_frame = tk.Frame(root, bg="orange")
